    ...
    <div className="space-y-8 px-4 py-6">
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="space-x-2">
          {priority && (
            <span className="tracing-wide rounded-full bg-red-500 px-2 py-1 text-sm uppercase text-red-50">
              Priority
            </span>
          )}
          <span className="tracing-wide rounded-full bg-green-500 px-2 py-1 text-sm uppercase text-green-50">
            {status} order
          </span>
        </div>
      </div>
